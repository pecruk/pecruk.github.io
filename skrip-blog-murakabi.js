let blogName = "Murakabi";
let blogLink = "https://pecruk.github.io/"; 
let authorName = "Pecruk";
let authorLink = "https://github.com/pecruk/"; 

let postsArray = [
[ "posts/2022-03-29-Membuat-Akun-Di-Github.html" ] ];
...
let headerHTML = '<ul> <li><a href="' + relativePath + '/index.html">Beranda</a></li>' + 
'<li><a href="' + relativePath + '/arsip-blog.html">Arsip Blog</a></li>' +
'<li><a href="' + relativePath + '/perihal.html">Perihal</a></li> </ul>';

let footerHTML = "<hr><p>" <a href='" + blogLink + "'>" + blogName + "</a> Oleh <a href='" + authorLink + "'>" + authorName + "</a><br>Situs ini dihosting Oleh <a href='https://github.com/'>GitHub</a></p>";
...
if ( postsArray.length > recentPostsCutoff ) {
  recentPostListHTML += '<li class="moreposts"><a href=' + relativePath + '/archive.html>\u00BB Posting Lainnya</a></li></ul>';
} else {
...
if ( postsArray.length < 2 ) {
  nextprevHTML = '<a href="' + relativePath + '/index.html">Beranda</a>';
} else if ( currentIndex === 0 ) {
  prevlink = postsArray[currentIndex + 1][0];
  nextprevHTML = '<a href="' + relativePath + '/index.html">Beranda</a> | <a href="'+ relativePath + '/' + prevlink +'">Posting Sebelumnya \u00BB</a>';
} else if ( currentIndex === postsArray.length - 1 ) {
  nextlink = postsArray[currentIndex - 1][0];
  nextprevHTML = '<a href="' + relativePath + '/' + nextlink +'">\u00AB Posting Berikutnya</a> | <a href="' + relativePath + '/index.html">Beranda</a>';
} else if ( 0 < currentIndex && currentIndex < postsArray.length - 1 ) {
  nextlink = postsArray[currentIndex - 1][0];
  prevlink = postsArray[currentIndex + 1][0];
  nextprevHTML = '<a href="' + relativePath + '/'+ nextlink +'">\u00AB Posting Berikutnya</a> | <a href="' + relativePath + '/index.html">Beranda</a> | <a href="' + relativePath + '/'+ prevlink +'">Posting Sebelumnya \u00BB</a>';
}
